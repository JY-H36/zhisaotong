...
class VectorStoreService:
    ...
    def get_retriever(self):
        return self.vector_store.as_retriever(search_kwargs={"k": chroma_config["retriever_k"]})
    ...
    def load_document(self):
        ...
        def get_file_documents(read_path: str):
            if read_path.endswith("txt"):
                return txt_loader(read_path, encoding="utf-8")

            if read_path.endswith("pdf"):
                return pdf_loader(read_path, encoding="utf-8")
